...
# 파이썬에서 한글 출력 문제가 있어서 추가 #

########### 1차시 / 최태오 / 연습 ###########

# 죄송합니다, PC를 새로 구매한 후에 한글을 설치하지 못해서 .py 형태로 전달 드립니다.
...
# (3) 작은 문제로 분해하고, 문제의 패턴을 발견하고, 어떤 데이터를 이용해야 \
# 하는지 결정
...
# 문제19) 사용자로부터 입력을 받는 아래의 예를 참고해서 아래의 요구사항을 프로그래
# 밍 해 본다.
...
# >>> Print("This is test!!")
# print라는 것은 존재하지만, Print라는 함수는 존재하지 않는다. 소문자 p로 바꾸면 오류가 해결된다.
